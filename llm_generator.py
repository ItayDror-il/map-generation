...
Generate realistic starting balances based on user's income bracket. For PORT (income) nodes, calculate bi-weekly pay:
| Income Bracket | Annual Midpoint | Bi-weekly (÷24) | Balance (cents) |
|----------------|-----------------|-----------------|-----------------|
| UNDER_25K | $20,000 | $833 | 83300 |
| BETWEEN_25K_AND_50K | $37,500 | $1,562 | 156200 |
| BETWEEN_50K_AND_100K | $75,000 | $3,125 | 312500 |
| BETWEEN_100K_AND_250K | $175,000 | $7,291 | 729100 |
| OVER_250K | $350,000 | $14,583 | 1458300 |

- PORT nodes: Use bi-weekly pay from table above (or default to 312500 if unknown)
- POD nodes: Start with 0 (empty buckets)
- DEPOSITORY_ACCOUNT: Small buffer like 50000-100000 cents ($500-$1000)
- LIABILITY_ACCOUNT: Realistic debt like 500000-2000000 cents ($5,000-$20,000)"""
