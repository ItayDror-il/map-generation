...
Input: "I get paid bi-weekly and want to save 20% and pay my rent"
Output:
{"nodes":[{"id":"a1b2c3d4-e5f6-7890-abcd-ef1234567890","type":"PORT","subtype":null,"name":"Paycheck","balance":0,"icon":"📥","position":{"x":100,"y":300}},{"id":"b2c3d4e5-f6a7-8901-bcde-f12345678901","type":"POD","subtype":null,"name":"Main Hub","balance":0,"icon":"💰","position":{"x":400,"y":300}},{"id":"c3d4e5f6-a7b8-9012-cdef-123456789012","type":"DEPOSITORY_ACCOUNT","subtype":"SAVINGS","name":"Savings","balance":0,"icon":"🏦","position":{"x":700,"y":200}},{"id":"d4e5f6a7-b8c9-0123-def0-234567890123","type":"POD","subtype":null,"name":"Rent","balance":0,"icon":"🏠","position":{"x":700,"y":400}}],"rules":[{"id":"e5f6a7b8-c9d0-1234-ef01-345678901234","sourceId":"a1b2c3d4-e5f6-7890-abcd-ef1234567890","trigger":{"type":"INCOMING_FUNDS","sourceId":"a1b2c3d4-e5f6-7890-abcd-ef1234567890","cron":null},"steps":[{"actions":[{"type":"PERCENTAGE","sourceId":"a1b2c3d4-e5f6-7890-abcd-ef1234567890","destinationId":"b2c3d4e5-f6a7-8901-bcde-f12345678901","amountInCents":0,"amountInPercentage":100,"groupIndex":0,"limit":null,"upToEnabled":null}]}]},{"id":"f6a7b8c9-d0e1-2345-f012-456789012345","sourceId":"b2c3d4e5-f6a7-8901-bcde-f12345678901","trigger":{"type":"INCOMING_FUNDS","sourceId":"b2c3d4e5-f6a7-8901-bcde-f12345678901","cron":null},"steps":[{"actions":[{"type":"PERCENTAGE","sourceId":"b2c3d4e5-f6a7-8901-bcde-f12345678901","destinationId":"c3d4e5f6-a7b8-9012-cdef-123456789012","amountInCents":0,"amountInPercentage":20,"groupIndex":0,"limit":null,"upToEnabled":null},{"type":"FIXED","sourceId":"b2c3d4e5-f6a7-8901-bcde-f12345678901","destinationId":"d4e5f6a7-b8c9-0123-def0-234567890123","amountInCents":150000,"amountInPercentage":0,"groupIndex":1,"limit":null,"upToEnabled":null}]}]}],"viewport":{"x":300,"y":100,"zoom":0.9}}

## Example 2: Business Owner with Tax Reserve
Input: "Small business owner, need to set aside 30% for taxes and pay myself a salary"
Output:
{"nodes":[{"id":"11111111-1111-1111-1111-111111111111","type":"PORT","subtype":null,"name":"Business Income","balance":0,"icon":"📥","position":{"x":100,"y":300}},{"id":"22222222-2222-2222-2222-222222222222","type":"POD","subtype":null,"name":"Tax Reserve","balance":0,"icon":"📋","position":{"x":400,"y":150}},{"id":"33333333-3333-3333-3333-333333333333","type":"POD","subtype":null,"name":"Owner Pay","balance":0,"icon":"💵","position":{"x":400,"y":450}},{"id":"44444444-4444-4444-4444-444444444444","type":"DEPOSITORY_ACCOUNT","subtype":"CHECKING","name":"Business Checking","balance":0,"icon":"🏦","position":{"x":700,"y":300}}],"rules":[{"id":"55555555-5555-5555-5555-555555555555","sourceId":"11111111-1111-1111-1111-111111111111","trigger":{"type":"INCOMING_FUNDS","sourceId":"11111111-1111-1111-1111-111111111111","cron":null},"steps":[{"actions":[{"type":"PERCENTAGE","sourceId":"11111111-1111-1111-1111-111111111111","destinationId":"22222222-2222-2222-2222-222222222222","amountInCents":0,"amountInPercentage":30,"groupIndex":0,"limit":null,"upToEnabled":null},{"type":"FIXED","sourceId":"11111111-1111-1111-1111-111111111111","destinationId":"33333333-3333-3333-3333-333333333333","amountInCents":500000,"amountInPercentage":0,"groupIndex":1,"limit":null,"upToEnabled":null},{"type":"PERCENTAGE","sourceId":"11111111-1111-1111-1111-111111111111","destinationId":"44444444-4444-4444-4444-444444444444","amountInCents":0,"amountInPercentage":100,"groupIndex":2,"limit":null,"upToEnabled":null}]}]}],"viewport":{"x":300,"y":100,"zoom":0.9}}

## Example 3: Savings Goal with Debt Payment
Input: "Save 20% for emergency fund, then use rest to pay credit card"
Output:
{"nodes":[{"id":"aaaa1111-bbbb-cccc-dddd-eeee11111111","type":"PORT","subtype":null,"name":"Income","balance":0,"icon":"📥","position":{"x":100,"y":300}},{"id":"aaaa2222-bbbb-cccc-dddd-eeee22222222","type":"POD","subtype":null,"name":"Emergency Fund","balance":0,"icon":"🛡️","position":{"x":400,"y":150}},{"id":"aaaa3333-bbbb-cccc-dddd-eeee33333333","type":"LIABILITY_ACCOUNT","subtype":"CREDIT_CARD","name":"Credit Card","balance":0,"icon":"💳","position":{"x":400,"y":450}}],"rules":[{"id":"aaaa5555-bbbb-cccc-dddd-eeee55555555","sourceId":"aaaa1111-bbbb-cccc-dddd-eeee11111111","trigger":{"type":"INCOMING_FUNDS","sourceId":"aaaa1111-bbbb-cccc-dddd-eeee11111111","cron":null},"steps":[{"actions":[{"type":"PERCENTAGE","sourceId":"aaaa1111-bbbb-cccc-dddd-eeee11111111","destinationId":"aaaa2222-bbbb-cccc-dddd-eeee22222222","amountInCents":0,"amountInPercentage":20,"groupIndex":0,"limit":null,"upToEnabled":null},{"type":"PERCENTAGE","sourceId":"aaaa1111-bbbb-cccc-dddd-eeee11111111","destinationId":"aaaa3333-bbbb-cccc-dddd-eeee33333333","amountInCents":0,"amountInPercentage":100,"groupIndex":1,"limit":null,"upToEnabled":null}]}]}],"viewport":{"x":300,"y":100,"zoom":0.9}}

## Example 4: Multiple Income Sources
Input: "I have a day job and freelance on the side. Keep freelance money separate for taxes."
Output:
{"nodes":[{"id":"job11111-2222-3333-4444-555566667777","type":"PORT","subtype":null,"name":"Salary","balance":0,"icon":"📥","position":{"x":100,"y":200}},{"id":"free1111-2222-3333-4444-555566667777","type":"PORT","subtype":null,"name":"Freelance","balance":0,"icon":"💼","position":{"x":100,"y":500}},{"id":"main1111-2222-3333-4444-555566667777","type":"DEPOSITORY_ACCOUNT","subtype":"CHECKING","name":"Main Checking","balance":0,"icon":"🏦","position":{"x":500,"y":200}},{"id":"tax11111-2222-3333-4444-555566667777","type":"POD","subtype":null,"name":"Freelance Taxes","balance":0,"icon":"📋","position":{"x":500,"y":400}},{"id":"bus11111-2222-3333-4444-555566667777","type":"DEPOSITORY_ACCOUNT","subtype":"CHECKING","name":"Business Account","balance":0,"icon":"🏦","position":{"x":500,"y":600}}],"rules":[{"id":"rule1111-2222-3333-4444-555566667777","sourceId":"job11111-2222-3333-4444-555566667777","trigger":{"type":"INCOMING_FUNDS","sourceId":"job11111-2222-3333-4444-555566667777","cron":null},"steps":[{"actions":[{"type":"PERCENTAGE","sourceId":"job11111-2222-3333-4444-555566667777","destinationId":"main1111-2222-3333-4444-555566667777","amountInCents":0,"amountInPercentage":100,"groupIndex":0,"limit":null,"upToEnabled":null}]}]},{"id":"rule2222-2222-3333-4444-555566667777","sourceId":"free1111-2222-3333-4444-555566667777","trigger":{"type":"INCOMING_FUNDS","sourceId":"free1111-2222-3333-4444-555566667777","cron":null},"steps":[{"actions":[{"type":"PERCENTAGE","sourceId":"free1111-2222-3333-4444-555566667777","destinationId":"tax11111-2222-3333-4444-555566667777","amountInCents":0,"amountInPercentage":30,"groupIndex":0,"limit":null,"upToEnabled":null},{"type":"PERCENTAGE","sourceId":"free1111-2222-3333-4444-555566667777","destinationId":"bus11111-2222-3333-4444-555566667777","amountInCents":0,"amountInPercentage":100,"groupIndex":1,"limit":null,"upToEnabled":null}]}]}],"viewport":{"x":300,"y":100,"zoom":0.9}}
